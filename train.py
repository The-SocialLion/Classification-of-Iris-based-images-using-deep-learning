...
model.add(tf.keras.layers.Conv2D(filters=64, kernel_size=(7, 7), activation='relu', input_shape=X_train.shape[1:]))
model.add(tf.keras.layers.Conv2D(filters=64, kernel_size=(7, 7), activation='relu'))
